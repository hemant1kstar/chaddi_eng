...
echo "<thead><tr><th>Subject</th><th>Test Name</th><th>No. of questions</th><th>Score</th><th>Date</th></tr>";
echo "</thead><tbody>";
while($row=mysqli_fetch_row($rs))
{
  $sql="SELECT * FROM mst_question where test_id='$row[5]'";
...
echo "<tr><td>$subject_name</td><td>$row[0]</td><td>$total_que</td><td>$row[3]</td><td>$row[2]</td>";
}
echo "</tbody></table>";
     ?>
