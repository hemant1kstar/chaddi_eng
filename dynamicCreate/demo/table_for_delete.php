...
<body>
    <form name="frmUser" method="post" action="delete_user.php?q=<?php echo $link; ?>">
            <table class="mdl-data-table mdl-js-data-table  mdl-shadow--2dp dataadd">
                ...
                while($row = mysqli_fetch_array($result)) {  
                 ?>
                <tr>
                    <td><input type="checkbox" name="id[]" class="mdl-data-table--selectable" value="<?php echo $row["id"];?>"></td>
                <?php
                ...
                <tr>
                    <td colspan="4">
                        <input type="submit" name="delete" value="Delete" id="checkBtn1" class="mdl-button mdl-js-button mdl-button--raised submitbtn"/>
                    </td>
                    <td></td>
                </tr>
            </table>
