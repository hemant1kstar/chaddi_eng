...
<head>
    ...
    <link href='css/StudentIdCard.css' rel='stylesheet'>
                    ...
                    <div id="dvContents">
                        <div class="main mdl-shadow--4dp" id="mains">
                            ...
                            <table class="studentinfo">
                                ...
                                <tr>
                                    <td>शाळेचे नाव</td>
                                    <td>: संत नामदेव उच्च माध्यमिक विद्यालय, लातूर</td>
                                </tr>
                                <tr>
    ...
    <script type="text/javascript">
        $(function() {
            $("#btnPrint").click(function() {
                ...
                frameDoc.document.write('<link href="css/StudentIdCard.css" rel="stylesheet" type="text/css" /><link href="css/ShikshAbhiyanForPrinting.css" rel="stylesheet" type="text/css" />');
