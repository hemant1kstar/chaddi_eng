...
<head>
    ...
    <title>Paperless System | Print Certificate</title>
            ...
            <div class="page-content">
                ...
                <div class="mdl-shadow--2dp reg_info">
                    <form action="" method="post">
                            <div>
                                <label class="customLabel" id="displayTableRegistrationLabel">Reg No.</label>
                                <?php
include("../connection.php");
            ...
            while($row = mysqli_fetch_array($result)){
             ...
             echo "</select>";
          ?>
                                <button class="mdl-button mdl-js-button mdl-button--primary mdl-js-ripple-effect" name="submit_student_info" type="submit">Submit</button>
                            </div>
                    </form>
                </div>
                <?php
                    ...
                    <div class="">
                        <div id="dvContents">
                            ...
                            <div class="main mdl-shadow--2dp" id="mains">
                                ...
                                <div class="pramanptra"><h3>प्राथमिक शिक्षणपूर्तता  प्रमाणपत्र </h3> </div>
