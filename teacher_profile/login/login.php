                        ...
                        <form action="<?php echo htmlspecialchars('welcome.php');?>" method="post">
                            <div class="mdl-grid">
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label textfield-demo">
                                    <input class="mdl-textfield__input" type="text" id="password" name="teachpass" />
                                    <label class="mdl-textfield__label" for="password">Password</label>
                                </div>
                                <button class="mdl-button mdl-js-button mdl-button--accent" type="submit" name="submitteacher">
                                 Submit
                                </button>
                            </div>
                        </form>
