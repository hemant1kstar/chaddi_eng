...
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
    ...
    <link rel="stylesheet" href="../css/main.css">
               <link href='../student_list/css/student_status.css' rel='stylesheet'>
                ...
                <span class="mdl-layout-title">Paperless System</span>
                 ...
                 <main class="mdl-layout__content">
                    ...
                    <div class="student_list mdl-shadow--2dp">
                      ...
                      <h4 id="form_header">Student Status</h4>
                      <div class="mdl-grid">
                    ...
                    <div>
          <input type='submit'  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent btn1" name='submit_status' value='Submit' >
                    </div>
                      </div>
                               </form>
                      </div>
                  ...
                  <div class="student_list mdl-shadow--2dp">
                      <h4 id="form_header">Status Wise Student List</h4>
                      <div class="mdl-grid">
                        <?php
