...
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
    ...
    <link rel="stylesheet" href="../css/main.css">
               <link href='../student_list/css/aadhar_card_wise.css' rel='stylesheet'>
...
-->
                ...
                <span class="mdl-layout-title">Paperless System</span>
                 ...
                 <main class="mdl-layout__content">
                    ...
                    <div class="student_list mdl-shadow--2dp">
                      ...
                      <h4 id="form_header">Aadhar Card</h4>
                      <div class="mdl-grid">
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                    ...
                    <div>
          <input type='submit'  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent btn1" name='submit_aadhar_card' value='Submit' >
                    </div>
                      </div>
                               </form>
                      </div>
                  ...
                  <div class="student_list mdl-shadow--2dp">
                      <h4 id="form_header">Aadhar Card Student List</h4>
                      <div class="mdl-grid">
                        <?php
