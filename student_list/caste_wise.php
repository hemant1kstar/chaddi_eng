...
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
    ...
    <link rel="stylesheet" href="../css/main.css">
               <link href='../student_list/css/caste_wise.css' rel='stylesheet'>
                ...
                <span class="mdl-layout-title">Paperless System</span>
                 ...
                 <main class="mdl-layout__content">
                    ...
                    <div class="student_list mdl-shadow--2dp">
                      ...
                      <h4 id="form_header">Caste Wise</h4>
                      <div class="mdl-grid">
                    ...
                    <div>
          <input type='submit'  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent btn1" name='submit_category' value='Submit' >
                    </div>
                      </div>
                               </form>
                      </div>
