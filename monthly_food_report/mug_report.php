...
<main class="mdl-layout__content">
    ...
    <div class="page-content">
     ...
     if(isset($_POST['daily_mug_info']))
     {
      ...
      if(mysqli_query($con,"INSERT INTO mug_report(date, total_student,prev_mug_remain, current_month_mug_got, total_mug, total_plates, mug_cooked, monthEnd_remaining_mug)values (N'$entry_date1',N'$t_student',N'$prev_month_remain_mug',N'$mug_got',N'$total_mug',N'$total_plates',N'$cooked_mug',N'$remaining_mug')"))
      {
            ...
            <div class="mug_entry_div">
                ...
                <form action="" method="post">
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                            <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_mug" name="prev_month_remain_mug" required/>
                            <label class="mdl-textfield__label" for="prev_month_remain_mug"> मागील महिना शिल्लक मुग</label>
                            <span class="mdl-textfield__error">Input is not a number!</span>
                        </div>
                    </div>
                    <div class="mdl-grid">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                            ...
                            <label class="mdl-textfield__label" for="mug_got"> चालू महिना प्राप्त मुग </label>
                            <span class="mdl-textfield__error">Input is not a number!</span>
                        </div>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                            <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_mug" name="total_mug" required/>
                            <label class="mdl-textfield__label" for="total_mug"> एकून मुग </label>
                            <span class="mdl-textfield__error">Input is not a number!</span>
                        </div>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                            ...
                            <label class="mdl-textfield__label" for="cooked_mug"> शिजवलेला मुग</label>
                            <span class="mdl-textfield__error">Input is not a number!</span>
                        </div>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                            <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="remaining_mug" name="remaining_mug" required/>
                            <label class="mdl-textfield__label" for="remaining_mug"> महिना अखेर शिल्लक मुग </label>
                            <span class="mdl-textfield__error">Input is not a number!</span>
                        </div>
...
<div class="mdl-tabs__panel" id="mug_report_panel">
    ...
    <script>
        ...
        xmlhttp.open("GET","php/monthly_mug_report.php?s_year="+str1+"&s_month="+str2,true);
        xmlhttp.send();
}
    </script>
