    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header">
            ...
            <div class="tabs mdl-js-ripple-effect">
                ...
                <a href="mug_report.php" class="mdl-layout__tab is-active"> मुग हिशोब </a>
...
if(isset($_GET['success1']))
{
 ...
 <?php
                  $result12=mysqli_query($con,"select * from food_daily_stock where food_name='mug'");
                $result_set=mysqli_fetch_array($result12);
                $mug_remaining=$result_set['last_month_stock'];
                $mug_current_month=$result_set['current_month_stock'];
                $total_current_mug=$mug_remaining+$mug_current_month;
 ...
 ?>
                        ...
                        <div class="mdl-shadow--2dp contentDiv">
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                <div class="mdl-tabs__tab-bar">
                                    <a href="#mug_entry_panel" class="mdl-tabs__tab is-active">Daily mug Entry</a>
                                    <a href="#mug_report_panel" class="mdl-tabs__tab">mug Report</a>
                                </div>
                                <div class="mdl-tabs__panel is-active" id="mug_entry_panel">
                                    <div class="mug_entry_div">
                                        <h2 id="form_header">Daily mug Entry Form</h2>
                                        <form action="mug_daily_report_submit.php" method="post">
                                    <div class="mdl-grid">
                                            ...
                                            <div class="mdl-grid">
                                                                                     <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                         <label class="" for="prev_month_remain_mug"> मागील महिना शिल्लक मुग</label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_mug" name="prev_month_remain_mug" value="<?php echo $mug_remaining;?>" required/>
                                        
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                                  <label class="" for="mug_got"> चालू महिना प्राप्त मुग </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="mug_got" name="mug_got" value="<?php echo $mug_current_month;?>" required/>
                                      
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="total_mug"> एकून मुग </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_mug" name="total_mug" value="<?php echo $total_current_mug;?>" required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                         <label class="" for="cooked_mug"> मुग वापरली </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_mug" name="cooked_mug" required/>
                                               
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                 <label class="" for="remaining_mug"> महिना अखेर शिल्लक मुग </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="remaining_mug" name="remaining_mug" required/>
                                 ...
                                 <label class="" for="total_expense"> एकूण खर्च </label>
                                            ...
                                            <div class="submitButtonDiv">
                                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" name="daily_mug_info" type="submit">Submit</button>
                                            </div>
                                        </form>
                                    </div>

                                </div>
                                <div class="mdl-tabs__panel" id="mug_report_panel">

                                    <div class="mug_report_div">
                                        <h2 id="form_header">Monthly mug  Report</h2>
                                        <div class="">
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-cell mdl-cell-8-col-tablet mdl-cell--4-col">
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_mug_report.php?s_year=" + str1 + "&s_month=" + str2 +"&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_mug").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_mug").value;
    var used_stock=document.getElementById("cooked_mug").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_mug").value=remaining_stock;
    }else{
