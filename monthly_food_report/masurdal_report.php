...
if(isset($_GET['success1']))
{
        ...
        ?>
            ...
            <?php
                  $result12=mysqli_query($con,"select * from food_daily_stock where food_name='masurdal'");
                $result_set=mysqli_fetch_array($result12);
                $masurdal_remaining=$result_set['last_month_stock'];
                $masurdal_current_month=$result_set['current_month_stock'];
                $total_current_masurdal=$masurdal_remaining+$masurdal_current_month;
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                ...
                                <div class="mdl-tabs__panel is-active" id="masurdal_entry_panel">
                                    <div class="masurdal_entry_div">
                                        ...
                                        <form action="masurdal_daily_report_submit.php" method="post">
                                <div class="mdl-grid">
                                            ...
                                            <div class="mdl-grid">
                  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                        <label class="" for="prev_month_remain_masurdal"> मागील महिना शिल्लक मसूरडाळ </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_masurdal" name="prev_month_remain_masurdal"  value="<?php echo $masurdal_remaining;?>" required/>
                                                  
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                         <label class="" for="masurdal_got"> चालू महिना प्राप्त मसूरडाळ </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="masurdal_got" name="masurdal_got"  value="<?php echo $masurdal_current_month;?>" required/>
                                               
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                         <label class="" for="total_masurdal"> एकून मसूरडाळ </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_masurdal" name="total_masurdal"  value="<?php echo $total_current_masurdal;?>" required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="cooked_masurdal"> शिजवलेली मसूरडाळ </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_masurdal" name="cooked_masurdal" required/>
                                                    
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                             <label class="" for="remaining_masurdal"> महिना अखेर शिल्लक मसूरडाळ </label>
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_masurdal_report.php?s_year=" + str1 + "&s_month=" + str2 +"&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_masurdal").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_masurdal").value;
    var used_stock=document.getElementById("cooked_masurdal").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_masurdal").value=remaining_stock;
    }else{
