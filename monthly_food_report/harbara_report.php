    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header">
            ...
            <div class="tabs mdl-js-ripple-effect">
                ...
                <a href="harbara_report.php" class="mdl-layout__tab is-active"> हरभरा हिशोब </a>
...
if(isset($_GET['success1']))
{
        ...
        ?>
                <?php
                  $result12=mysqli_query($con,"select * from food_daily_stock where food_name='harbara'");
                $result_set=mysqli_fetch_array($result12);
                $harbara_remaining=$result_set['last_month_stock'];
                $harbara_current_month=$result_set['current_month_stock'];
                $total_current_harbara=$harbara_remaining+$harbara_current_month;
                        ...
                        <div class="mdl-shadow--2dp  contentDiv">
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                <div class="mdl-tabs__tab-bar">
                                    <a href="#harbara_entry_panel" class="mdl-tabs__tab is-active">Daily harbara Entry</a>
                                    <a href="#harbara_report_panel" class="mdl-tabs__tab">harbara Report</a>
                                </div>
                                <div class="mdl-tabs__panel is-active" id="harbara_entry_panel">
                                    <div class="harbara_entry_div">
                                        <h2 id="form_header">Daily harbara Entry Form</h2>
                                        <form action="harbara_daily_report_submit.php" method="post">
                                     <div class="mdl-grid">
                                            ...
                                            <div class="mdl-grid">
                                                  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                           <label class="" for="prev_month_remain_harbara"> मागील महिना शिल्लक हरभरा </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_harbara" name="prev_month_remain_harbara" value="<?php echo $harbara_remaining;?>" required/>
                                                  
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                           <label class="" for="harbara_got"> चालू महिना प्राप्त हरभरा </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="harbara_got" name="harbara_got" value="<?php echo $harbara_current_month;?>" required/>
                                       
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                <label class="" for="total_harbara"> एकून हरभरा </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_harbara" name="total_harbara" value="<?php echo $total_current_harbara;?>" required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                       <label class="" for="cooked_harbara"> शिजवलेला हरभरा </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_harbara" name="cooked_harbara" required/>
                                                 
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                     <label class="" for="remaining_harbara"> महिना अखेर शिल्लक हरभरा </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="remaining_harbara" name="remaining_harbara" required/>
                  ...
                  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                 <label class="" for="total_expense"> एकूण खर्च </label>
                                            ...
                                            <div class="submitButtonDiv">
                                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" name="daily_harbara_info" type="submit">Submit</button>
                                            </div>
                                        </form>
                                    </div>

                                </div>
                                <div class="mdl-tabs__panel" id="harbara_report_panel">

                                    <div class="harbara_report_div">
                                        <h2 id="form_header">Monthly harbara  Report</h2>
                                        <div class="">
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-cell mdl-cell-8-col-tablet mdl-cell--4-col">
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_harbara_report.php?s_year=" + str1 + "&s_month=" + str2 +"&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_harbara").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_harbara").value;
    var used_stock=document.getElementById("cooked_harbara").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_harbara").value=remaining_stock;
    }else{
