...
-->
     ...
     if(isset($_POST['daily_mirchi_powder_info']))
     {
      ...
      if(mysqli_query($con,"INSERT INTO mirchi_powder_report(date, total_student,prev_mirchi_powder_remain, current_month_mirchi_powder_got, total_mirchi_powder, total_plates, mirchi_powder_cooked, monthEnd_remaining_mirchi_powder)values (N'$entry_date1',N'$t_student',N'$prev_month_remain_mirchi_powder',N'$mirchi_powder_got',N'$total_mirchi_powder',N'$total_plates',N'$cooked_mirchi_powder',N'$remaining_mirchi_powder')"))
      {
                                    ...
                                    <div class="mirchi_powder_entry_div">
                                        ...
                                        <form action="" method="post">
                                            <div class="mdl-grid">
                                                ...
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_mirchi_powder" name="prev_month_remain_mirchi_powder" required/>
                                                    <label class="mdl-textfield__label" for="prev_month_remain_mirchi_powder"> मागील महिना शिल्लक मिर्ची पावडर </label>
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                            </div>
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    ...
                                                    <label class="mdl-textfield__label" for="mirchi_powder_got"> चालू महिना प्राप्त मिर्ची पावडर </label>
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_mirchi_powder" name="total_mirchi_powder" required/>
                                                    <label class="mdl-textfield__label" for="total_mirchi_powder"> एकून मिर्ची पावडर </label>
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    ...
                                                    <label class="mdl-textfield__label" for="cooked_mirchi_powder">मिर्ची पावडर वापरली</label>
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    ...
                                                    <label class="mdl-textfield__label" for="remaining_mirchi_powder"> महिना अखेर शिल्लक मिर्ची पावडर </label>
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_mirchi_powder_report.php?s_year=" + str1 + "&s_month=" + str2, true);
            xmlhttp.send();
        }
