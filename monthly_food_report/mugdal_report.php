...
if(isset($_GET['success1']))
{
        ...
        ?>
                  ...
                  <?php
                $result12=mysqli_query($con,"select * from food_daily_stock where food_name='mugdal'");
                $result_set=mysqli_fetch_array($result12);
                $mugdal_remaining=$result_set['last_month_stock'];
                $mugdal_current_month=$result_set['current_month_stock'];
                $total_current_mugdal=$mugdal_remaining+$mugdal_current_month;
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                ...
                                <div class="mdl-tabs__panel is-active" id="mugdal_entry_panel">
                                    <div class="mugdal_entry_div">
                                        ...
                                        <form action="mugdal_daily_report_submit.php" method="post">
                                    <div class="mdl-grid">
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                            ...
                                            <div class="mdl-grid">
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                  <label class="" for="prev_month_remain_mugdal"> मागील महिना शिल्लक मुगडाळ</label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_mugdal" name="prev_month_remain_mugdal" value="<?php echo $mugdal_remaining;?>" required/>
                                          
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                         <label class="" for="mugdal_got"> चालू महिना प्राप्त मुगडाळ </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="mugdal_got" name="mugdal_got" value="<?php echo $mugdal_current_month;?>" required/>
                                            
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                      <label class="" for="total_mugdal"> एकून मुगडाळ </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_mugdal" name="total_mugdal" value="<?php echo $total_current_mugdal;?>" required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                      <label class="" for="cooked_mugdal"> शिजवलेली मुगडाळ</label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_mugdal" name="cooked_mugdal" onchange="myFunction1(this.value)" required/>
                                                  
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                       <label class="" for="remaining_mugdal"> महिना अखेर शिल्लक मुगडाळ </label>
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_mugdal_report.php?s_year=" + str1 + "&s_month=" + str2+"&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_mugdal").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_mugdal").value;
    var used_stock=document.getElementById("cooked_mugdal").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_mugdal").value=remaining_stock;
    }else{
