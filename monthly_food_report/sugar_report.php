...
if(isset($_GET['success1']))
{
        ...
        ?>
            ...
            <?php
                $result12=mysqli_query($con,"select * from food_daily_stock where food_name='sugar'");
                $result_set=mysqli_fetch_array($result12);
                $sugar_remaining=$result_set['last_month_stock'];
                $sugar_current_month=$result_set['current_month_stock'];
                $total_current_sugar=$sugar_remaining+$sugar_current_month;
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                ...
                                <div class="mdl-tabs__panel is-active" id="sugar_entry_panel">
                                    <div class="sugar_entry_div">
                                        ...
                                        <form action="sugar_daily_report_submit.php" method="post">
                                <div class="mdl-grid">
                                            ...
                                            <div class="mdl-grid">
                                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                   <label class="" for="prev_month_remain_sugar"> मागील महिना शिल्लक साखर </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_sugar" name="prev_month_remain_sugar" value="<?php echo $sugar_remaining;?>" required/>
                                            
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                             <label class="" for="sugar_got"> चालू महिना प्राप्त साखर </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sugar_got" name="sugar_got" value="<?php echo $sugar_current_month;?>" required/>
                                  
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="total_sugar"> एकून साखर</label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_sugar" name="total_sugar" value="<?php echo $total_current_sugar;?>" required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                        <label class="" for="cooked_sugar"> साखर वापरली </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_sugar" name="cooked_sugar" required/>
                                                
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="remaining_sugar"> महिना अखेर शिल्लक साखर </label>
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_sugar_report.php?s_year=" + str1 + "&s_month=" + str2 +"&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_sugar").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_sugar").value;
    var used_stock=document.getElementById("cooked_sugar").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_sugar").value=remaining_stock;
    }else{
