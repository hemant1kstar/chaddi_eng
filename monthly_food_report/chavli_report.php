...
if(isset($_GET['success1']))
{
        ...
        ?>
            ...
            <?php
                  $result12=mysqli_query($con,"select * from food_daily_stock where food_name='chavli'");
                $result_set=mysqli_fetch_array($result12);
                $chavli_remaining=$result_set['last_month_stock'];
                $chavli_current_month=$result_set['current_month_stock'];
                $total_current_chavli=$chavli_remaining+$chavli_current_month;
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                ...
                                <div class="mdl-tabs__panel is-active" id="chavli_entry_panel">
                                    <div class="chavli_entry_div">
                                        ...
                                        <form action="chavli_daily_report_submit.php" method="post">
                                        <div class="mdl-grid">
                                            ...
                                            <div class="mdl-grid">
                                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                                <label class="" for="prev_month_remain_chavli"> मागील महिना शिल्लक चवली </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_chavli" name="prev_month_remain_chavli" value="<?php echo $chavli_remaining;?>" required/>
                                                    
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                     <label class="" for="chavli_got"> चालू महिना प्राप्त चवली </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="chavli_got" name="chavli_got" value="<?php echo $chavli_current_month;?>" required/>
                                                   
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="total_chavli"> एकून चवली </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_chavli" name="total_chavli" value="<?php echo $total_current_chavli;?>" required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                           <label class="" for="cooked_chavli"> शिजवलेली चवली </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_chavli" name="cooked_chavli" required/>
                                             
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="remaining_chavli"> महिना अखेर शिल्लक चवली </label>
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_chavli_report.php?s_year=" + str1 + "&s_month=" + str2 +"&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_chavli").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_chavli").value;
    var used_stock=document.getElementById("cooked_chavli").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_chavli").value=remaining_stock;
    }else{
