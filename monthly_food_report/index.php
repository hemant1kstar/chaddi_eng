    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header">
            ...
            <div class="mdl-layout__header-row">
                <!-- Title -->
                <span class="mdl-layout-title">Food Report</span>
...
<div class="tabs mdl-js-ripple-effect">
    <a href="index.php" class="mdl-layout__tab is-active">Rice Report</a>
...
<div class="mdl-tabs__panel" id="rice_report_panel">
    ...
    <script>
        ...
        xmlhttp.open("GET","monthly_rice_report.php?s_year="+str1+"&s_month="+str2,true);
        xmlhttp.send();
}
    </script>
