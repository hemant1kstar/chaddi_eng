...
if(isset($_GET['success1']))
{
        ...
        ?>
            ...
            <?php
                  $result12=mysqli_query($con,"select * from food_daily_stock where food_name='turdal'");
                $result_set=mysqli_fetch_array($result12);
                $turdal_remaining=$result_set['last_month_stock'];
                $turdal_current_month=$result_set['current_month_stock'];
                $total_current_turdal=$turdal_remaining+$turdal_current_month;
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                ...
                                <div class="mdl-tabs__panel is-active" id="turdal_entry_panel">
                                    <div class="turdal_entry_div">
                                        ...
                                        <form action="turdal_daily_report_submit.php" method="post">
                             ...
                             <div class="mdl-grid">
                                            ...
                                            <div class="mdl-grid">
                     <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                             <label class="" for="prev_month_remain_turdal"> मागील महिना शिल्लक तुरडाळ</label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_turdal" name="prev_month_remain_turdal" value="<?php echo $turdal_remaining;?>" required/>
                                                
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                     <label class="" for="turdal_got"> चालू महिना प्राप्त तुरडाळ </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="turdal_got" name="turdal_got" value="<?php echo $turdal_current_month;?>"  required/>
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                      <label class="" for="total_turdal"> एकून तुरडाळ </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_turdal" name="total_turdal" value="<?php echo $total_current_turdal;?>"  required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="cooked_turdal"> शिजवलेली तुरडाळ</label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_turdal" name="cooked_turdal" required/>
                                              
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="remaining_turdal"> महिना अखेर शिल्लक तुरडाळ </label>
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_turdal_report.php?s_year=" + str1 + "&s_month=" + str2 + "&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_turdal").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_turdal").value;
    var used_stock=document.getElementById("cooked_turdal").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_turdal").value=remaining_stock;
    }else{
