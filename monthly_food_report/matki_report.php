...
if(isset($_GET['success1']))
{
        ...
        ?>
                ...
                <?php
                  $result12=mysqli_query($con,"select * from food_daily_stock where food_name='matki'");
                $result_set=mysqli_fetch_array($result12);
                $matki_remaining=$result_set['last_month_stock'];
                $matki_current_month=$result_set['current_month_stock'];
                $total_current_matki=$matki_remaining+$matki_current_month;
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                ...
                                <div class="mdl-tabs__panel is-active" id="matki_entry_panel">
                                    <div class="matki_entry_div">
                                        ...
                                        <form action="matki_daily_report_submit.php" method="post">
                                               <div class="mdl-grid">
                                            ...
                                            <div class="mdl-grid">
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                   <label class="" for="prev_month_remain_matki"> मागील महिना शिल्लक मटकी </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_matki" name="prev_month_remain_matki" value="<?php echo $matki_remaining;?>" required/>
                                         
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="matki_got"> चालू महिना प्राप्त मटकी </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="matki_got" name="matki_got" value="<?php echo $matki_current_month;?>" required/>
                                                    
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                     <label class="" for="total_matki"> एकून मटकी </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_matki" name="total_matki" value="<?php echo $total_current_matki;?>" required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                     <label class="" for="cooked_matki"> शिजवलेली मटकी </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_matki" name="cooked_matki" required/>
                                                   
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                    <label class="" for="remaining_matki"> महिना अखेर शिल्लक मटकी </label>
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_matki_report.php?s_year=" + str1 + "&s_month=" + str2 +"&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_matki").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_matki").value;
    var used_stock=document.getElementById("cooked_matki").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_matki").value=remaining_stock;
    }else{
