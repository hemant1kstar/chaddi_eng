...
<label class="report_sub_title"> ( वाटाणा कि. ग्राम मध्ये )</label>
<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
    <thead>
        <tr>
            ...
            <th>दिनांक </th>
            <th>पटसंख्या </th>
            <th>मागील महिना शिल्लक वाटाणा </th>
            <th>चालू महिना प्राप्त वाटाणा </th>
            <th>एकून वाटाणा </th>
...
$query1=mysqli_query($con,"SELECT * 
 FROM vatana_report Where YEAR(date)=$s_year and MONTH(date)=$s_month");
              ...
              while($row1=mysqli_fetch_array($query1))
             {
                  ...
                  $prev_vatana=$row1['prev_vatana_remain'];
                  $current_vatana_got=$row1['current_month_vatana_got'];
                  $total_vatana1=$row1['total_vatana'];
                  ...
                  echo "<td>$prev_vatana</td>";
                  echo "<td>$current_vatana_got</td>";
                  echo "<td>$total_vatana1</td>";
