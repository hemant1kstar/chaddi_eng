...
<h3 class="report_title">शाळा स्तरावर ठेवावयाची  नियमित खर्च नोंदवही भाग -१ (मुगडाळ हिशोब )</h3>
...
<label class="report_sub_title"> ( मुगडाळ कि. ग्राम मध्ये )</label>
<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
    <thead>
        <tr>
            ...
            <th>दिनांक </th>
            <th>पटसंख्या </th>
            <th>मागील महिना शिल्लक मुगडाळ </th>
            <th>चालू महिना प्राप्त मुगडाळ </th>
            <th>एकून मुगडाळ </th>
            <th>लाभाथ्री संख्या ( ताटांची संख्या )</th>
            <th> शिजवलेली मुगडाळ</th>
            <th>महिना अखेर शिल्लक मुगडाळ </th>
...
//              $query1 = mysqli_query($con,"SELECT * FROM mugdal_report") or die(mysqli_error());
...
$query1=mysqli_query($con,"SELECT * 
 FROM mugdal_report Where YEAR(date)=$s_year and MONTH(date)=$s_month and class_category='$s_category'");
              $s_no=1;
              while($row1=mysqli_fetch_array($query1))
             {
                  ...
                  $prev_mugdal=$row1['prev_mugdal_remain'];
                  $current_mugdal_got=$row1['current_month_mugdal_got'];
                  $total_mugdal1=$row1['total_mugdal'];
                  $total_plates1=$row1['total_plates'];
                  $cooked_mugdal1=$row1['mugdal_cooked'];
                  $remaining_mugdal1=$row1['monthEnd_remaining_mugdal'];
                  ...
                  echo "<td>$prev_mugdal</td>";
                  echo "<td>$current_mugdal_got</td>";
                  echo "<td>$total_mugdal1</td>";
                  echo "<td>$total_plates1</td>";
                  echo "<td>$cooked_mugdal1</td>";
                  echo "<td>$remaining_mugdal1</td>";
