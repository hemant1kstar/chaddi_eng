...
<h3 class="report_title">शाळा स्तरावर ठेवावयाची  नियमित खर्च नोंदवही भाग -१ ( हरभरा हिशोब )</h3>
...
<label class="report_sub_title"> ( हरभरा कि. ग्राम मध्ये )</label>
<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
    <thead>
        <tr>
            ...
            <th>दिनांक </th>
            <th>पटसंख्या </th>
            <th>मागील महिना शिल्लक हरभरा </th>
            <th>चालू महिना प्राप्त हरभरा </th>
            <th>एकून हरभरा </th>
            <th>लाभाथ्री संख्या ( ताटांची संख्या )</th>
            <th>शिजवलेला हरभरा </th>
            <th>महिना अखेर शिल्लक हरभरा </th>
...
//              $query1 = mysqli_query($con,"SELECT * FROM harbara_report") or die(mysqli_error());
...
$query1=mysqli_query($con,"SELECT * 
 FROM harbara_report Where YEAR(date)=$s_year and MONTH(date)=$s_month and class_category='$s_category'");
              $s_no=1;
              while($row1=mysqli_fetch_array($query1))
             {
                  ...
                  $prev_harbara=$row1['prev_harbara_remain'];
                  $current_harbara_got=$row1['current_month_harbara_got'];
                  $total_harbara1=$row1['total_harbara'];
                  $total_plates1=$row1['total_plates'];
                  $cooked_harbara1=$row1['harbara_cooked'];
                  $remaining_harbara1=$row1['monthEnd_remaining_harbara'];
                  ...
                  echo "<td>$prev_harbara</td>";
                  echo "<td>$current_harbara_got</td>";
                  echo "<td>$total_harbara1</td>";
                  echo "<td>$total_plates1</td>";
                  echo "<td>$cooked_harbara1</td>";
                  echo "<td>$remaining_harbara1</td>";
