...
<h3 class="report_title">शाळा स्तरावर ठेवावयाची  नियमित खर्च नोंदवही भाग -१ ( साखर हिशोब )</h3>
...
<label class="report_sub_title"> ( साखर कि. ग्राम मध्ये )</label>
<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
    <thead>
        <tr>
            ...
            <th>दिनांक </th>
            <th>पटसंख्या </th>
            <th>मागील महिना शिल्लक साखर </th>
            <th>चालू महिना प्राप्त साखर </th>
            <th>एकून साखर </th>
            <th>लाभाथ्री संख्या ( ताटांची संख्या )</th>
            <th> साखर वापरली </th>
            <th>महिना अखेर शिल्लक साखर </th>
...
//              $query1 = mysqli_query($con,"SELECT * FROM sugar_report") or die(mysqli_error());
...
$query1=mysqli_query($con,"SELECT * 
 FROM sugar_report Where YEAR(date)=$s_year and MONTH(date)=$s_month and class_category='$s_category'");
              $s_no=1;
              while($row1=mysqli_fetch_array($query1))
             {
                  ...
                  $prev_sugar=$row1['prev_sugar_remain'];
                  $current_sugar_got=$row1['current_month_sugar_got'];
                  $total_sugar1=$row1['total_sugar'];
                  $total_plates1=$row1['total_plates'];
                  $cooked_sugar1=$row1['sugar_cooked'];
                  $remaining_sugar1=$row1['monthEnd_remaining_sugar'];
                  ...
                  echo "<td>$prev_sugar</td>";
                  echo "<td>$current_sugar_got</td>";
                  echo "<td>$total_sugar1</td>";
                  echo "<td>$total_plates1</td>";
                  echo "<td>$cooked_sugar1</td>";
                  echo "<td>$remaining_sugar1</td>";
