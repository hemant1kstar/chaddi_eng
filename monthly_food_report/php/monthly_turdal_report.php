...
<h3 class="report_title">शाळा स्तरावर ठेवावयाची  नियमित खर्च नोंदवही भाग -१ ( तुरडाळ हिशोब )</h3>
...
<label class="report_sub_title"> ( तुरडाळ कि. ग्राम मध्ये )</label>
<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
    <thead>
        <tr>
            ...
            <th>दिनांक </th>
            <th>पटसंख्या </th>
            <th>मागील महिना शिल्लक तुरडाळ </th>
            <th>चालू महिना प्राप्त तुरडाळ </th>
            <th>एकून तुरडाळ </th>
            <th>लाभाथ्री संख्या ( ताटांची संख्या )</th>
            <th>शिजवलेली तुरडाळ</th>
            <th>महिना अखेर शिल्लक तुरडाळ </th>
...
//              $query1 = mysqli_query($con,"SELECT * FROM turdal_report") or die(mysqli_error());
...
$query1=mysqli_query($con,"SELECT * 
 FROM turdal_report Where YEAR(date)=$s_year and MONTH(date)=$s_month and class_category='$s_category'");
              $s_no=1;
              while($row1=mysqli_fetch_array($query1))
             {
                  ...
                  $prev_turdal=$row1['prev_turdal_remain'];
                  $current_turdal_got=$row1['current_month_turdal_got'];
                  $total_turdal1=$row1['total_turdal'];
                  $total_plates1=$row1['total_plates'];
                  $cooked_turdal1=$row1['turdal_cooked'];
                  $remaining_turdal1=$row1['monthEnd_remaining_turdal'];
                  ...
                  echo "<td>$prev_turdal</td>";
                  echo "<td>$current_turdal_got</td>";
                  echo "<td>$total_turdal1</td>";
                  echo "<td>$total_plates1</td>";
                  echo "<td>$cooked_turdal1</td>";
                  echo "<td>$remaining_turdal1</td>";
