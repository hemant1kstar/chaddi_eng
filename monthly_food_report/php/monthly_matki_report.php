...
//              $query1 = mysqli_query($con,"SELECT * FROM matki_report") or die(mysqli_error());
...
$query1=mysqli_query($con,"SELECT * 
 FROM matki_report Where YEAR(date)=$s_year and MONTH(date)=$s_month");
              $s_no=1;
              while($row1=mysqli_fetch_array($query1))
             {
                  ...
                  $prev_matki=$row1['prev_matki_remain'];
                  $current_matki_got=$row1['current_month_matki_got'];
                  $total_matki1=$row1['total_matki'];
                  $total_plates1=$row1['total_plates'];
                  $cooked_matki1=$row1['matki_cooked'];
                  $remaining_matki1=$row1['monthEnd_remaining_matki'];
                  echo "<tr>";
                  echo "<td>$s_no</td>";
                  echo "<td>$e_date1</td>";
                  echo "<td>$t_student</td>";
                  echo "<td>$prev_matki</td>";
                  echo "<td>$current_matki_got</td>";
                  echo "<td>$total_matki1</td>";
                  echo "<td>$total_plates1</td>";
                  echo "<td>$cooked_matki1</td>";
                  echo "<td>$remaining_matki1</td>";
                  echo "<td></td>";
                  echo "</tr>";
