    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header">
            ...
            <div class="tabs mdl-js-ripple-effect">
                ...
                <a href="jire_report.php" class="mdl-layout__tab is-active"> जिरे हिशोब </a>
...
if(isset($_GET['success1']))
{
        ...
        ?>
                  ...
                  <?php
                  $result12=mysqli_query($con,"select * from food_daily_stock where food_name='jire'");
                $result_set=mysqli_fetch_array($result12);
                $jire_remaining=$result_set['last_month_stock'];
                $jire_current_month=$result_set['current_month_stock'];
                $total_current_jire=$jire_remaining+$jire_current_month;
                        ...
                        <div class="mdl-shadow--2dp  contentDiv">
                            ...
                            <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect" id="tabs1">
                                <div class="mdl-tabs__tab-bar">
                                    <a href="#jire_entry_panel" class="mdl-tabs__tab is-active">Daily jire Entry</a>
                                    <a href="#jire_report_panel" class="mdl-tabs__tab">jire Report</a>
                                </div>
                                <div class="mdl-tabs__panel is-active" id="jire_entry_panel">
                                    <div class="jire_entry_div">
                                        <h2 id="form_header">Daily jire Entry Form</h2>
                                        <form action="jire_daily_report_submit.php" method="post">
                                              <div class="mdl-grid">
                                            ...
                                            <div class="mdl-grid">
                                                  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                        <label class="" for="prev_month_remain_jire"> मागील महिना शिल्लक जिरे </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="prev_month_remain_jire" name="prev_month_remain_jire" value="<?php echo $jire_remaining;?>" required/>
                                               
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                            <label class="" for="jire_got"> चालू महिना प्राप्त जिरे </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="jire_got" name="jire_got" value="<?php echo $jire_current_month;?>" required/>
                                          
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                            <label class="" for="total_jire"> एकून जिरे </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="total_jire" name="total_jire" value="<?php echo $total_current_jire;?>" required/>
                                            ...
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                              <label class="" for="cooked_jire"> जिरे वापरले </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="cooked_jire" name="cooked_jire" required/>
                                              
                                                    <span class="mdl-textfield__error">Input is not a number!</span>
                                                </div>
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                                            <label class="" for="remaining_jire"> महिना अखेर शिल्लक जिरे </label>
                                                    <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="remaining_jire" name="remaining_jire" required/>
              ...
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--8-col-tablet mdl-cell--4-col">
                                 <label class="" for="total_expense"> एकूण खर्च </label>
                                            ...
                                            <div class="submitButtonDiv">
                                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" name="daily_jire_info" type="submit">Submit</button>
                                            </div>
                                        </form>
                                    </div>

                                </div>
                                <div class="mdl-tabs__panel" id="jire_report_panel">

                                    <div class="jire_report_div">
                                        <h2 id="form_header">Monthly jire  Report</h2>
                                        <div class="">
                                            <div class="mdl-grid">
                                                <div class="mdl-textfield mdl-js-textfield mdl-cell mdl-cell-8-col-tablet mdl-cell--4-col">
    ...
    <script>
        function showReport() {
            ...
            xmlhttp.open("GET", "php/monthly_jire_report.php?s_year=" + str1 + "&s_month=" + str2 +"&s_category=" + str3, true);
            xmlhttp.send();
        }
...
function myFunction2(val) {
    ...
    document.getElementById("cooked_jire").value=used_stock1;
    document.getElementById("total_expense").value=expense1;
    
    
    var total_stock=document.getElementById("total_jire").value;
    var used_stock=document.getElementById("cooked_jire").value;
    var remaining_stock=total_stock-used_stock;
    
    if (remaining_stock >= 0) {
      document.getElementById("remaining_jire").value=remaining_stock;
    }else{
